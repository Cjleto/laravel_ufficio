...
//        dd($id);
    ...
    public function edit($id){
        ...
        $album = Album::find($id);
        //dd($album->user->id. " ---- ". Auth::user()->id);
        //metodo alternativo ai Gate per proteggere la rotta
        /*if($album->user->id !== Auth::user()->id)
            abort(401, 'Non sei il proprietario di questo album');*/
        if(\Gate::denies('manage-album', $album)){
            abort(401, 'Non sei il proprietario di questo album!(GATE)');
        }
